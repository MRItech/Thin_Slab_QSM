...
% it calculates a mask that idintify smooth peice-wise constant regions (exludes edges and noisy voxels), by
% calculating gardient of mag, then setting 1 to any region that is below a
% speciefied threshold that relfects possible noise level
% the result is a binary mask, which consider regions outside FOV as well!
